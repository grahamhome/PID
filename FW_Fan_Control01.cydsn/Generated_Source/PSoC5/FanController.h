...
/* They are defined starting with cy_boot v3.0 */
    ...
    #error Component FanController_v3_10 requires cy_boot v3.0 or later
#endif /* (CY_PSOC5LP) */
...
#define FanController_DAMPING_FACTOR              (63u)
#define FanController_INIT_ALERT_ENABLE           (1u)
...
#define FanController_TOLERANCE                   (2u)
...
#define FanController_ALERT_MASK_LSB_CONTROL_REG            \
                                    (* (reg8 *) FanController_B_FanCtrl_AlertMaskLSB__CONTROL_REG)
#define FanController_ALERT_MASK_LSB_CONTROL_PTR            \
    ...
    #define FanController_ALERT_MASK_MSB_CONTROL_REG        \
                           (* (reg8 *) FanController_B_FanCtrl_CtrlAlertMSB_AlertMaskMSB__CONTROL_REG)
...
#define FanController_STALL_ERROR_LSB_STATUS_REG            \
                                    (* (reg8 *) FanController_B_FanCtrl_StallError_LSB__STATUS_REG)
#define FanController_STALL_ERROR_LSB_STATUS_PTR            \
                                    (  (reg8 *) FanController_B_FanCtrl_StallError_LSB__STATUS_REG)

#if(FanController_NUMBER_OF_FANS > 8u)
    #define FanController_STALL_ERROR_MSB_STATUS_REG        \
                                    (* (reg8 *) FanController_B_FanCtrl_StallStatusMSB_StallError_MSB__STATUS_REG)
...
#define FanController_TACH_FAN_COUNTR_AUX_CTL_REG           \
                                    (* (reg8 *) FanController_FanTach_FanCounter__CONTROL_AUX_CTL_REG)
...
#if(CY_PSOC4)
    #define FanController_TACH_FAN_COUNTER_REG            (* (reg8 *) FanController_FanTach_FanCounter__COUNT_REG)
    #define FanController_TACH_FAN_COUNTER_PTR            (  (reg8 *) FanController_FanTach_FanCounter__COUNT_REG)
#endif /* (CY_PSOC4) */
...
#define FanController_OVERRIDE                   (0x40u)
#if (CY_PSOC4)
    #define FanController_SW_EOC                     (0x08u)
#endif /* (CY_PSOC4) */
#if (!FanController_IS_MANUAL_MODE)
    #define FanController_SW_SPEED_ERROR             (0x10u)
#endif /* (!FanController_IS_MANUAL_MODE) */
...
*/
#if (!FanController_IS_MANUAL_MODE)
    #define  FanController_OverrideHardwareControl(override) \
                                                        FanController_OverrideAutomaticControl(override)
#endif /* (!FanController_IS_MANUAL_MODE) */

#define FanController_TOLERANCE_FACTOR           ((2 * 0.01))
#define FanController_STALL_ALERT_CLEAR_SHIFT    (0x03u)
#define FanController_SPEED_ALERT_CLEAR_SHIFT    (0x04u)
#define FanController_ALERT_CLEAR_SHIFT          (0x03u)
#define FanController_STALL_ALERT_CLEAR          (uint8)(0x01u << FanController_STALL_ALERT_CLEAR_SHIFT)
#define FanController_SPEED_ALERT_CLEAR          (uint8)(0x01u << FanController_SPEED_ALERT_CLEAR_SHIFT)
#define FanController_ALERT_CLEAR_MASK           (uint8)(0x03u << FanController_ALERT_CLEAR_SHIFT)
